...
\begin{equation}\label{eq:weakFormDisc}
    - \dot{\testFunMat} \quadMat \stateMat \approx \testFunMat \quadMat \mathbf{F}(\stateMat,\timeVec,\params) .
\end{equation}
...
\end{figure}
\input{LogisticGrowthExample.tex}
To generate these results, see \emph{juliaCon2026\_extendAbstractResults.jl} in the Git repository. For more extensive examples, comparisons, and numerical results see \citep{RummelMessengerBeckerEtAl2025arXiv250208881b}.
